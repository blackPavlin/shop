...
func (_q *OrderQuery) QueryUsers() *UserQuery {
...
func (_q *OrderQuery) QueryOrderProducts() *OrderProductQuery {
...
func (_q *OrderQuery) WithUsers(opts ...func(*UserQuery)) *OrderQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *OrderQuery) WithOrderProducts(opts ...func(*OrderProductQuery)) *OrderQuery {
	query := (&OrderProductClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *OrderQuery) loadUsers(ctx context.Context, query *UserQuery, nodes []*Order, init func(*Order), assign func(*Order, *User)) error {
...
func (_q *OrderQuery) loadOrderProducts(ctx context.Context, query *OrderProductQuery, nodes []*Order, init func(*Order), assign func(*Order, *OrderProduct)) error {
