...
func (m *MockCategoryService) Create(ctx context.Context, category *entities.Category) (entities.CategoryID, error) {
	m.ctrl.T.Helper()
...
func (m *MockCategoryService) DeleteByID(ctx context.Context, id entities.CategoryID) error {
	m.ctrl.T.Helper()
...
func (mr *MockCategoryServiceMockRecorder) DeleteByID(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteByID", reflect.TypeOf((*MockCategoryService)(nil).DeleteByID), ctx, id)
}

// Find mocks base method.
func (m *MockCategoryService) Find(ctx context.Context) ([]*entities.Category, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCategoryServiceMockRecorder) Find(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Find", reflect.TypeOf((*MockCategoryService)(nil).Find), ctx)
}

// FindByID mocks base method.
func (m *MockCategoryService) FindByID(ctx context.Context, id entities.CategoryID) (*entities.Category, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCategoryServiceMockRecorder) FindByID(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockCategoryService) Update(ctx context.Context, category *entities.Category) (*entities.Category, error) {
	m.ctrl.T.Helper()
