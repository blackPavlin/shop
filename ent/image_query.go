...
func (iq *ImageQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (iq *ImageQuery) FirstIDX(ctx context.Context) int64 {
...
func (iq *ImageQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (iq *ImageQuery) OnlyIDX(ctx context.Context) int64 {
...
func (iq *ImageQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (iq *ImageQuery) IDsX(ctx context.Context) []int64 {
	ids, err := iq.IDs(ctx)
	if err != nil {
		panic(err)
	}
