...
func (a *Address) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(a.Flat); err != nil {
		return nil, err
	}
	node.Fields[5] = &Field{
		Type:  "int",
	...
	if buf, err = json.Marshal(a.House); err != nil {
		return nil, err
	}
	node.Fields[6] = &Field{
		Type:  "int",
	...
	if buf, err = json.Marshal(a.Letter); err != nil {
		return nil, err
	}
	node.Fields[7] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(a.Postcode); err != nil {
		return nil, err
	}
	node.Fields[8] = &Field{
		Type:  "int",
...
func (c *Cart) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     c.ID,
		Type:   "Cart",
		Fields: make([]*Field, 5),
	...
	if buf, err = json.Marshal(c.ProductID); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "int64",
...
func (o *Order) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(o.UserID); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "int64",
...
func (pr *Product) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(pr.CategoryID); err != nil {
		return nil, err
	}
	node.Fields[4] = &Field{
		Type:  "int64",
...
func (c *Client) noder(ctx context.Context, table string, id int64) (Noder, error) {
	...
	case cart.Table:
		query := c.Cart.Query().
			Where(cart.ID(id))
		query, err := query.CollectFields(ctx, "Cart")
		if err != nil {
			return nil, err
		}
		n, err := query.Only(ctx)
